...
{
    public class LogicWithFactory
    {
        private readonly IRepository<Student> _repository;

        public LogicWithFactory()
        {
            _repository = RepositoryFactory.CreateRepository();
        }

        public LogicWithFactory(string connectionString)
        {
            _repository = RepositoryFactory.CreateRepository(connectionString);
        }
